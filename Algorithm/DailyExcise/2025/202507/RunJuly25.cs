...
namespace Algorithm.DailyExcise
{
    public class RunJuly25
    {
        public static void Run()
        {
            ...
            var doesValidArrayExist = new DoesValidArrayExistClass();
            var doesValidArrayExistResult = doesValidArrayExist.DoesValidArrayExist(new int[] { 1,1,0});//true

            doesValidArrayExistResult = doesValidArrayExist.DoesValidArrayExist(new int[] { 1, 1});//true
        }
    }
}
