...
namespace Algorithm.DailyExcise
{
    public class RundailyNov24
    {
        public static void Run()
        {
            ...
            var networkDelayTimeClass = new NetworkDelayTimeClass();
            var networkDelayTimeResult = networkDelayTimeClass.NetworkDelayTime(
                new int[][] {
                  new int[]{ 2, 1, 1},
                  new int[]{ 2, 3, 1},
                  new int[]{ 3, 4, 1}
            ...
            networkDelayTimeResult = networkDelayTimeClass.NetworkDelayTime2(
                new int[][] {
                  new int[]{ 2, 1, 1},
                  new int[]{ 2, 3, 1},
                  new int[]{ 3, 4, 1}
