...
namespace Algorithm.DailyExcise
{
    public class RunFeb25
    {
        public static void Run()
        {
            ...
            var browserHistory = new BrowserHistoryClass("leetcode.com");
            browserHistory.Visit("google.com");//你原本在浏览 "leetcode.com" 。访问 "google.com"
            browserHistory.Visit("facebook.com");     // 你原本在浏览 "google.com" 。访问 "facebook.com"
            browserHistory.Visit("youtube.com");      // 你原本在浏览 "facebook.com" 。访问 "youtube.com"
            var browserHistoryResult = browserHistory.Back(1);                   // 你原本在浏览 "youtube.com" ，后退到 "facebook.com" 并返回 "facebook.com"

            browserHistoryResult = browserHistory.Back(1);                   // 你原本在浏览 "facebook.com" ，后退到 "google.com" 并返回 "google.com"
            browserHistoryResult = browserHistory.Forward(1);                // 你原本在浏览 "google.com" ，前进到 "facebook.com" 并返回 "facebook.com"
